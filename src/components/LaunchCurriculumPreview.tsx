  ...
  return (
    <section className="workspace-hero">
      <article className="summary-card">
        ...
        <p>
          The structure sheet now has a published launch contract so the app knows which parts of the
      ...
      <article className="summary-card">
        ...
        <p>
          ...
          whole workbook, while every published term now also carries a curriculum-map block derived
      ...
      <article className="summary-card">
        ...
        <h3>Mapped from the workbook, not invented twice</h3>
        <div className="note-snippet-list">
